...
if(isset($_POST['add'])) {
    ...
    mysqli_query($con, "INSERT INTO tb_dokter (id_dokter, nama_dokter, spesialis, alamat, no_tlpn ) VALUES ('$uuid','$nama','$spesialis','$alamat','$telp') ") or die (mysqli_error($con));
    ...
    mysqli_query($con, "UPDATE  tb_dokter SET nama_dokter = '$nama',
                        ...
                        no_tlpn='$telp' WHERE id_dokter = '$id'") or die (mysqli_error($con));
