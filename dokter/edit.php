    ...
    <div class= "box">
        ...
        <div class="row">
            ...
            <div class="from-group">
                ...
                <input type ="text" name="nama" id="nama" value="<?=$data['nama_dokter']?>" class="form-control" required autofous>
            </div>
            <div class="from-group">
            ...
            <div class="from-group">
                ...
                <input type ="number" name="telp" id="telp" value="<?=$data['no_tlpn']?>" class="form-control" required>
            </div>
