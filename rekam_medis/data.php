        ...
        <table class= "table table-striped table-bordered table-hover" id="rekammedis">
            <thead>
                <tr>
                    ...
                    <th>Poliklinik</th>
                    <th>Data Obat</th>
                    <th><i class="glyphicon glyiphicon-cog"></i></th>                                    
                </tr> 
            </thead>
            <tbody>
                <?php
                ...
                <tr>
                        ...
                        <td>
                            <?php 
                            $sql_obat = mysqli_query($con, "SELECT *FROM tb_rm_obat  JOIN tb_obat ON tb_rm_obat.id_obat = tb_obat.id_obat WHERE id_rm = '$data[id_rm]'") or die (mysql_error($con));
                            while ($data_obat = mysqli_fetch_array($sql_obat)) {
                                echo $data_obat ['nama_obat']."<br>";
                            }?>
                        </td>
                        <td>
                        <a href="del.php?id=<?=$data['id_rm']?>" class="btn btn-warning btn-xs" onclick="return confirm('Yakin akan menghapus data?')"><i class="glyphicon glyphicon-trash"></i></a>                
